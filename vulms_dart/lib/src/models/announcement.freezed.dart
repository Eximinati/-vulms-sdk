...
mixin _$Announcement {
 ...
 String get courseCode; String get title; String? get body; DateTime? get date; String? get author;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,courseCode,title,body,date,author);

@override
String toString() {
  return 'Announcement(courseCode: $courseCode, title: $title, body: $body, date: $date, author: $author)';
}
...
@useResult
$Res call({
 String courseCode, String title, String? body, DateTime? date, String? author
});
...
/// Create a copy of Announcement
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? courseCode = null,Object? title = null,Object? body = freezed,Object? date = freezed,Object? author = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String courseCode,  String title,  String? body,  DateTime? date,  String? author)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Announcement() when $default != null:
return $default(_that.courseCode,_that.title,_that.body,_that.date,_that.author);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String courseCode,  String title,  String? body,  DateTime? date,  String? author)  $default,) {final _that = this;
switch (_that) {
case _Announcement():
return $default(_that.courseCode,_that.title,_that.body,_that.date,_that.author);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String courseCode,  String title,  String? body,  DateTime? date,  String? author)?  $default,) {final _that = this;
switch (_that) {
case _Announcement() when $default != null:
return $default(_that.courseCode,_that.title,_that.body,_that.date,_that.author);case _:
  return null;
...
class _Announcement implements Announcement {
  const _Announcement({required this.courseCode, required this.title, this.body, this.date, this.author});
...
/// Create a copy of Announcement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? courseCode = null,Object? title = null,Object? body = freezed,Object? date = freezed,Object? author = freezed,}) {
